...
import com.agile.framework.query.DatabaseSchema;

public class DB implements DatabaseSchema {

	public final static SYS_AREA SYS_AREA = new SYS_AREA(); 
	public final static SYS_CONFIG SYS_CONFIG = new SYS_CONFIG(); 
	public final static SYS_CONSTRAINT SYS_CONSTRAINT = new SYS_CONSTRAINT(); 
	...
	public final static SYS_RESOURCE SYS_RESOURCE = new SYS_RESOURCE(); 
	public final static SYS_ROLE SYS_ROLE = new SYS_ROLE(); 
	public final static SYS_ROLE_MENU SYS_ROLE_MENU = new SYS_ROLE_MENU(); 
	public final static SYS_ROLE_PERMISSION SYS_ROLE_PERMISSION = new SYS_ROLE_PERMISSION(); 
	public final static SYS_TABLE_LOG SYS_TABLE_LOG = new SYS_TABLE_LOG(); 
	public final static SYS_TABLE_NAME SYS_TABLE_NAME = new SYS_TABLE_NAME(); 
